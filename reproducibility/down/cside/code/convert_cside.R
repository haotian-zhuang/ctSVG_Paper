for (f in list.files("svg/crop/down/cside/raw_res/", pattern = ".rds")) {
  print(f)
  
  raw_res <- readRDS(paste0("svg/crop/down/cside/raw_res/", f))
  ...
  saveRDS(res_cside, file = paste0("svg/crop/down/cside/", f))
}
