...
for filepath in glob.glob('svg/crop/down/spatialde/data/counts/*.csv.gz'):
    f = os.path.basename(filepath)
    
    print(f'Processing file {f}')

    counts = pd.read_csv('svg/crop/down/spatialde/data/counts/' + f, index_col=0)
    sample_info = pd.read_csv('svg/crop/down/spatialde/data/sample_info/' + f, index_col=0)
    ...
    res_spatialde.to_csv('svg/crop/down/spatialde/raw_res/' + f)
