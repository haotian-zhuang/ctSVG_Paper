...
clu.list <- readRDS("svg/sim_mouse_brain_v2/simdata/clusterlist.rds")
jac.mat <- readRDS("svg/sim_mouse_brain_v2/simdata/jaccardmat.rds")
...
saveRDS(res_ctsvg, file = "svg/sim_mouse_brain_v2/method/ctsvg/res.rds")
